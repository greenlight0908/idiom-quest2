...
const CACHE = "idiom-quest-v88-seven-eleven-alley-cat";
const V18_SCENES=[
...
const V28_ASSETS=["./assets/v28/characters/cleo-v28.png"];
const V29_ASSETS=["./assets/v29/backgrounds/station-wayfinding-v29.png"];
const V30_ASSETS=["./assets/v30/characters/creatures/school-rooster-sprites-v30.png"];
const V31_ASSETS=["./assets/v31/backgrounds/seven-eleven-exterior-v31.png","./assets/v31/backgrounds/seven-eleven-interior-v31.png","./assets/v31/characters/creatures/korean-alley-cat-v31.png"];
const CORE = ["./","./index.html","./manifest.json","./icon-192.png","./icon-512.png","./captain-cast-v1.png","./assets/data/pos-questions-v1.js","./assets/v18/characters/avatar-lineup-v18.png",...V18_SCENES,...PLAYER_IMAGES,...NPC_IMAGES,...CREATURE_IMAGES,...STATUE_IMAGES,...V19_PLAYER_SEATED,...V19_STUDY_BACK,...V19_POET_SEATED,...V19_PASSENGER_SEATED,...V19_TEACHERS,...V19_SPECIAL,...V20_ASSETS,...V21_ASSETS,...V22_ASSETS,...V23_ASSETS,...V24_ASSETS,...V25_ASSETS,...V26_ASSETS,...V27_ASSETS,...V28_ASSETS,...V29_ASSETS,...V30_ASSETS,...V31_ASSETS,...CAPTAIN_PIXEL_SCENES];
